...
**repo_server_name** - имя виртуального хоста репозитория. По-умолчанию localhost.servapp.ru (dummy-домен, резолвится в 127.0.1)



### roles/peervpn/vars/main.yml
**repo_url** - url по которому скрипт ожидает http доступ к репозиторию. По-умолчанию По-умолчанию localhost.servapp.ru (dummy-домен, резолвится в 127.0.1)
